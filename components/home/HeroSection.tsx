  ...
  return (
    <div className="text-center px-4 w-full max-w-7xl mx-auto">
      ...
      <div className="flex flex-row items-center justify-center gap-3 w-full max-w-md mx-auto mb-20 md:mb-32">
        <Link href="#" className="btn-primary flex-1 px-4 py-3.5 rounded-full text-sm md:text-base font-medium text-center shadow-xl shadow-red-500/10 whitespace-nowrap">
          Book Now
        </Link>
        <Link href="#" className="btn-secondary flex-1 px-4 py-3.5 rounded-full text-sm md:text-base font-medium text-center whitespace-nowrap">
          Contact Us
        </Link>
      </div>
      <div className="w-full max-w-5xl mx-auto mb-24 md:mb-32">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-8 items-center justify-center opacity-80">
          {[ { val: '500+', label: 'Active Students' }, { val: '98%', label: 'Pass Rate' }, { val: '50+', label: 'Expert Tutors' }, { val: '24/7', label: 'Support' } ].map((stat, i) => (
            <div key={i} className="flex flex-col items-center">
              <span className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">{stat.val}</span>
