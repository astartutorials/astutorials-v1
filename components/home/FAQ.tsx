  ...
  const faqs = [
    {
      ...
      answer: "Registration is simple. Click on the 'Book a Tutorial Session' button at the top of the page, select your course code, and choose a tutor that fits your schedule."
    },
    {
