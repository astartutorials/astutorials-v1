 ...
 *
 * To run a new cohort: update the dates, price and label below. To pull the
 * promo down early: set END_DATE to a past date, or drop the entries from
 * Navbar/Footer/app/page.tsx.
 */
...
const END_DATE = new Date("2026-10-04T23:59:59Z");
